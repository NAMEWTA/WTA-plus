...
async function restart() {
  ...
  try {
    ...
    await adminSso.startSsoLogin({ authorizeUrl: context.ssoAuthorizeUrl, clientId: import.meta.env.VITE_APP_CLIENT_ID,
      redirectUri: adminSsoRedirectUri(), returnTo: returnTo.value });
  } catch (error) {
