...
- `backend/wta-modules/wta-system/src/main/java/org/namewta/system/service/impl/SysDictTypeServiceImpl.java`
- `backend/wta-modules/wta-system/src/main/java/org/namewta/system/controller/system/SysDictDataController.java`
- `frontend/apps/admin-web/src/utils/dict.ts`
- `frontend/apps/admin-web/src/components/DictTag/index.vue`
- `frontend/packages/web-domains/system/src/runtime.ts`
