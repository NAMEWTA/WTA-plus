...
shared_path_owners: ["<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/controller/admin/NotifyInboxController.java</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/usecase/NotifyInboxUseCase.java</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/service/runtime/NotifyInboxService.java</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/dao/NotifyNotificationDao.java</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/domain/vo/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/mapper/NotifyMessageRecipientMapper.java</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/resources/mapper/notify/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/packages/domains/notify/src/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/packages/web-domains/notify/src/InboxPage.vue</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/apps/admin-web/src/utils/push.ts</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/apps/admin-web/src/layout/components/notice/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/packages/api-contracts/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/tooling/openapi/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>backend/wta-admin/src/test/java/org/namewta/test/notify/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)", "<Path>frontend/e2e/</Path> => single-agent (Lead; exclusive current workspace; T-41 turn only)"]
---
