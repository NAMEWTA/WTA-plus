...
shared_path_owners: ["<Path>backend/wta-common/wta-common-oss/src/main/java/org/namewta/common/oss/client/AbstractOssClientImpl.java</Path> => single-agent (Lead; exclusive current workspace; T-45 turn only)", "<Path>backend/wta-common/wta-common-oss/src/main/java/org/namewta/common/oss/model/</Path> => single-agent (Lead; exclusive current workspace; T-45 turn only)", "<Path>backend/wta-modules/wta-system/src/main/java/org/namewta/system/oss/readiness/</Path> => single-agent (Lead; exclusive current workspace; T-45 turn only)", "<Path>frontend/packages/web-domains/system/src/oss-config/</Path> => single-agent (Lead; exclusive current workspace; T-45 turn only)", "<Path>frontend/packages/domains/system/src/oss-config/</Path> => single-agent (Lead; exclusive current workspace; T-45 turn only)", "<Path>backend/wta-admin/src/test/java/org/namewta/test/oss/readiness/</Path> => single-agent (Lead; exclusive current workspace; T-45 turn only)"]
---
