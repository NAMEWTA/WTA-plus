#!/usr/bin/env python3
"""Serial local T-11 checks. No release promotion or external writes."""
import json
import os
...
name = sys.argv[1]
assert name.startswith('T-11-') and '/' not in name
mode = sys.argv[2]
shim = Path(tempfile.mkdtemp(prefix='t11-pnpm-', dir=root / 'temp/team/lead'))
