...
describe('system resource transports', () => {
  it('preserves the complete resource method and path matrix', async () => {
    ...
    expect(requests).toEqual([
      ...
      { url: '/system/dict/data/update', method: 'post', data: form },
      { url: '/system/dict/data/data%2F1,2', method: 'post' },
      ...
      { url: '/system/dict/type/update', method: 'post', data: form },
      { url: '/system/dict/type/type%2F1,2', method: 'post' },
      { url: '/system/dict/type/refreshCache', method: 'post' },
      ...
      { url: '/system/config/update', method: 'post', data: form },
      { url: '/system/config/updateByKey', method: 'post', data: { configKey: 'site/name', configValue: 'NAMEWTA' } },
      { url: '/system/config/config%2F1,2', method: 'post' },
      { url: '/system/config/refreshCache', method: 'post' },
