...
owner: codex:/root
expected_changes: ["<Path>frontend/packages/domains/**</Path>", "<Path>frontend/packages/web-domains/**</Path>", "<Path>frontend/packages/platform/auth/README.md</Path>", "<Path>frontend/apps/**</Path>", "<Path>frontend/e2e/**</Path>", "<Path>frontend/tooling/architecture/**</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>", "<Path>frontend/README.md</Path>", "<Path>frontend/.codex/skills/plus-ui-domain-development/**</Path>"]
writable_paths: ["<Path>frontend/packages/domains/**</Path>", "<Path>frontend/packages/web-domains/**</Path>", "<Path>frontend/packages/platform/auth/README.md</Path>", "<Path>frontend/apps/**</Path>", "<Path>frontend/e2e/**</Path>", "<Path>frontend/tooling/architecture/**</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>", "<Path>frontend/README.md</Path>", "<Path>frontend/.codex/skills/plus-ui-domain-development/**</Path>"]
read_only_paths: ["<Path>ruoyi-vue-plus-namewta/**</Path>", "<Path>frontend/packages/api-contracts/generated/**</Path>", "<Path>frontend/packages/platform/**</Path>", "<Path>frontend/packages/adapters/**</Path>"]
shared_paths: ["<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>", "<Path>frontend/apps/admin-web/src/router/adminManifestRegistry.ts</Path>"]
shared_path_owners: ["<Path>frontend/package.json</Path> => T-01", "<Path>frontend/pnpm-lock.yaml</Path> => T-01", "<Path>frontend/apps/admin-web/src/router/adminManifestRegistry.ts</Path> => T-01"]
---
