...
ready: true
risk: "high"
blocked_by: ["T-02", "T-04", "T-05", "T-06", "T-07", "T-08", "T-09", "T-10", "T-11", "T-12", "T-13", "T-14", "T-15", "T-16", "T-17", "T-18", "T-19", "T-20", "T-21", "T-22", "T-23", "T-24", "T-25", "T-26", "T-27", "T-28", "T-29", "T-31", "T-32", "T-33", "T-34", "T-35", "T-36", "T-37", "T-38", "T-39", "T-40", "T-41", "T-42", "T-43", "T-44", "T-45", "T-46", "T-47", "T-48", "T-49", "T-50"]
...
T03重复施工已按revision163取消；当前617a369真实HTTP边界/签名/堆/消费者及full-core证据见evidence/T-03-replan-2026-09-23.md。该待实施依赖边移除，AC-003仍必须在本票最终源码组合复验，不自动视为已完成。
