#!/usr/bin/env python3
"""Opt-in, owned T-39 deadline and Profile/Wake MySQL/Redis acceptance runner."""
...
def main():
    ...
    report = {'gate': 'T-39 real deadline, Enterprise queued notification and Wake', 'run_id': run_id,
              'mode': 'acceptance',
              'acceptance': False,
    ...
    try:
        ...
        selectors = 'NotifyDeadlineIntegrationTest,EnterpriseQueuedNotificationIntegrationTest,NotifyWakeIntegrationTest'
        ...
        for path in (TEST_REPORT, PROFILE_REPORT, WAKE_REPORT):
