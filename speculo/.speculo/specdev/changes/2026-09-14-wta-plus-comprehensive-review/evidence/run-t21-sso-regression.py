...
try:
    mysql_id = run(["docker", "run", "-d", "--name", mysql, "--label", "namewta.test.owner=T-21-regression", "-p", "127.0.0.1::3306",
    ...
    redis_id = run(["docker", "run", "-d", "--name", redis, "--label", "namewta.test.owner=T-21-regression", "-p", "127.0.0.1::6379",
