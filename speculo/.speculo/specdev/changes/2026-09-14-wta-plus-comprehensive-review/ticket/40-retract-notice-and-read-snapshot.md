...
shared_path_owners: ["<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/usecase/NotifyNoticeUseCase.java</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/service/NotifyNoticeService.java</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/service/NotifyNoticePublisherService.java</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/service/runtime/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/dao/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/controller/admin/NotifyInboxController.java</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/usecase/NotifyInboxUseCase.java</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>frontend/packages/web-domains/notify/src/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>frontend/packages/domains/notify/src/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>frontend/apps/admin-web/src/layout/components/notice/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>frontend/apps/admin-web/src/utils/push.ts</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>backend/wta-admin/src/test/java/org/namewta/test/notify/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)", "<Path>frontend/e2e/</Path> => single-agent (Lead; exclusive current workspace; T-40 turn only)"]
---
...
2. 让公告状态、相应 snapshot/intent 关联及 cancel 在同一 DSTransactional 中提交；重新发布版本不可误取消。
