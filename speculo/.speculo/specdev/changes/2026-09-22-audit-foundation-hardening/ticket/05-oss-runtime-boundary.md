...
risk: "high"
blocked_by: ["T-04"]
contract_ids: ["O-01", "O-02", "O-03", "O-04"]
owner: "audit-lead"
expected_changes: ["<Path>backend/wta-modules/wta-system/**</Path>", "<Path>backend/wta-common/wta-common-oss/**</Path>", "<Path>backend/wta-admin/src/main/resources/**</Path>", "<Path>backend/wta-admin/src/test/**</Path>", "<Path>frontend/packages/web-domains/system/**</Path>", "<Path>frontend/e2e/**</Path>", "<Path>scripts/ci/**</Path>", "<Path>docs/**</Path>"]
writable_paths: ["<Path>backend/wta-modules/wta-system/**</Path>", "<Path>backend/wta-common/wta-common-oss/**</Path>", "<Path>backend/wta-admin/src/main/resources/**</Path>", "<Path>backend/wta-admin/src/test/**</Path>", "<Path>frontend/packages/web-domains/system/**</Path>", "<Path>frontend/e2e/**</Path>", "<Path>scripts/ci/**</Path>", "<Path>docs/**</Path>"]
read_only_paths: ["<Path>backend/wta-modules/wta-sso/**</Path>", "<Path>frontend/apps/sso-web/**</Path>"]
shared_paths: []
shared_path_owners: []
---

# Ticket T-05：OSS按需访问与迁移互斥

总体 Map：<Path>{roots.state}/specdev/changes/2026-09-22-audit-foundation-hardening/tickets-map.md</Path>。上游 Spec：<Path>{roots.state}/specdev/changes/2026-09-22-audit-foundation-hardening/spec.md</Path>。完成 Evidence：<Path>{roots.state}/specdev/changes/2026-09-22-audit-foundation-hardening/evidence/T-05.md</Path>。先读 Map、适用项目 Skill，再读本票。

## 1. 战略与来源

来源 USER-DECISION:2026-09-22 与 <Path>docs/reviews/WTA-plus-review-64b4ea7.md</Path> 的 O-01, O-02, O-03, O-04。目标：无MinIO不阻止核心启动；未配canary不阻止合法对象操作；策略不可读是未知；恢复与清理互斥；旧OSS列表响应不覆盖新筛选。
...
无MinIO不阻止核心启动；未配canary不阻止合法对象操作；策略不可读是未知；恢复与清理互斥；旧OSS列表响应不覆盖新筛选。 错误必须可恢复且不显示伪成功，不放大无关配置故障。
...
|---|---|---|---|
| 正常/失败/边界 | 最小权限MinIO真实上传/下载、禁止桶管理权限仍可运行；真实DB恢复/清理竞态；OSS查询乱序组件/浏览器测试。 | 真实断言通过；无供应商真实发送 | <Path>{roots.state}/specdev/changes/2026-09-22-audit-foundation-hardening/evidence/T-05.md</Path> |
| 回归 | 原质量门禁中的受影响模块检查 | 不关闭规则、不丢弃负向测试 | <Path>{roots.state}/specdev/changes/2026-09-22-audit-foundation-hardening/evidence/T-05.md</Path> |
...
- [ ] O-01, O-02, O-03, O-04 的可观察结果和负向断言通过。
