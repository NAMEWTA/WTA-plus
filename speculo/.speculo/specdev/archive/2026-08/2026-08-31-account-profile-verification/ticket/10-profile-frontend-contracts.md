...
expected_changes:
  ...
  - "<Path>frontend/packages/web-domains/profile/package.json</Path>"
  - "<Path>frontend/packages/web-domains/profile/tsconfig.json</Path>"
  - "<Path>frontend/packages/web-domains/profile/src/index.ts</Path>"
  - "<Path>frontend/packages/web-domains/profile/src/runtime.ts</Path>"
  - "<Path>frontend/apps/admin-web/package.json</Path>"
  - "<Path>frontend/pnpm-lock.yaml</Path>"
  - "<Path>frontend/tooling/architecture/test/domain-layout.test.mjs</Path>"
writable_paths:
  - "<Path>frontend/packages/domains/profile/**</Path>"
  - "<Path>frontend/packages/web-domains/profile/package.json</Path>"
  - "<Path>frontend/packages/web-domains/profile/tsconfig.json</Path>"
  - "<Path>frontend/packages/web-domains/profile/README.md</Path>"
  - "<Path>frontend/packages/web-domains/profile/src/index.ts</Path>"
  - "<Path>frontend/packages/web-domains/profile/src/runtime.ts</Path>"
  - "<Path>frontend/packages/web-domains/profile/src/page-types.d.ts</Path>"
  - "<Path>frontend/apps/admin-web/package.json</Path>"
  - "<Path>frontend/pnpm-lock.yaml</Path>"
  - "<Path>frontend/tooling/architecture/test/domain-layout.test.mjs</Path>"
read_only_paths:
...
shared_paths:
  ...
  - "<Path>frontend/pnpm-lock.yaml</Path>"
shared_path_owners:
  - "<Path>frontend/packages/web-domains/profile/package.json</Path> => T-10"
  - "<Path>frontend/packages/web-domains/profile/src/index.ts</Path> => T-10"
  - "<Path>frontend/apps/admin-web/package.json</Path> => T-10"
  - "<Path>frontend/pnpm-lock.yaml</Path> => T-10"
---
