...
DRIVER = Path('/tmp/wta-t39/run-notify-deadline-integration-v2.py')
spec = importlib.util.spec_from_file_location('t39_driver_v2', DRIVER)
...
class DriverSafetyTest(unittest.TestCase):
    ...
    def test_four_exact_fresh_classes_positive_zero_skip(self):
        with tempfile.TemporaryDirectory() as directory:
            started = time.time_ns()
            paths = []
            for klass in (driver.TEST_CLASS, driver.PROFILE_CLASS, driver.WAKE_CLASS, driver.REDIS_CLASS):
