...
import org.namewta.common.liteflow.utils.LiteFlowUtils;
...
import org.namewta.workflow.api.domain.StartProcessReturnDTO;
import org.namewta.workflow.common.ConditionalOnEnable;
import org.namewta.workflow.common.enums.TaskAssigneeType;
...
import org.namewta.workflow.service.IFlwTaskAssigneeService;
...
import static org.namewta.workflow.common.constant.FlowConstant.*;
...
public class FlwTaskServiceImpl implements IFlwTaskService {
    ...
    public void setCopy(Task task, List<FlowCopyBo> flowCopyList) {
        ...
        flwCommonService.sendMessage(
            List.of(org.namewta.workflow.common.enums.MessageTypeEnum.SYSTEM_MESSAGE.getCode()),
            "您收到一条新的流程抄送，请及时查看。",
            "单据抄送提醒",
