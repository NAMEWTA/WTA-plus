...
expected_changes: ["<Path>frontend/packages/domains/workflow/**</Path>", "<Path>frontend/packages/web-domains/workflow/**</Path>", "<Path>frontend/src/api/workflow/category/**</Path>", "<Path>frontend/src/api/workflow/definition/**</Path>", "<Path>frontend/src/api/workflow/spel/**</Path>", "<Path>frontend/src/views/workflow/category/**</Path>", "<Path>frontend/src/views/workflow/processDefinition/**</Path>", "<Path>frontend/src/views/workflow/spel/**</Path>", "<Path>frontend/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/src/router/adminManifestRegistry.test.ts</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
writable_paths: ["<Path>frontend/packages/domains/workflow/**</Path>", "<Path>frontend/packages/web-domains/workflow/**</Path>", "<Path>frontend/src/api/workflow/category/**</Path>", "<Path>frontend/src/api/workflow/definition/**</Path>", "<Path>frontend/src/api/workflow/spel/**</Path>", "<Path>frontend/src/views/workflow/category/**</Path>", "<Path>frontend/src/views/workflow/processDefinition/**</Path>", "<Path>frontend/src/views/workflow/spel/**</Path>", "<Path>frontend/e2e/workflow-definition.spec.ts</Path>", "<Path>frontend/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/src/router/adminManifestRegistry.test.ts</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
read_only_paths: ["<Path>frontend/packages/domains/identity-access/**</Path>", "<Path>frontend/packages/platform/**</Path>", "<Path>frontend/src/components/Process/**</Path>"]
shared_paths: ["<Path>frontend/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/src/router/adminManifestRegistry.test.ts</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
shared_path_owners: ["<Path>frontend/src/router/adminManifestRegistry.ts</Path> => T-07 composition owner; T-08 scoped writer for workflow domain/manifest inputs and selected IDs only (DEV-T08-001)", "<Path>frontend/src/router/adminManifestRegistry.test.ts</Path> => T-07 test owner; T-08 scoped writer for workflow selected and runtime-key-unselected assertions only (DEV-T08-003)", "<Path>frontend/package.json</Path> => T-03 policy owner; T-08 scoped writer for two actually consumed workflow workspace:* dependencies only (DEV-T08-001)", "<Path>frontend/pnpm-lock.yaml</Path> => T-03 policy owner; T-08 scoped writer for matching root specifiers and workflow package importers only (DEV-T08-001)"]
---
