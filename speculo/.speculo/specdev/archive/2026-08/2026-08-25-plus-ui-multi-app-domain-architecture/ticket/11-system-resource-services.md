...
writable_paths: ["<Path>frontend/packages/domains/system-admin/**</Path>", "<Path>frontend/packages/web-domains/system-admin/**</Path>", "<Path>frontend/src/api/system/dict/**</Path>", "<Path>frontend/src/api/system/config/**</Path>", "<Path>frontend/src/api/system/notice/**</Path>", "<Path>frontend/src/api/system/oss/**</Path>", "<Path>frontend/src/api/system/ossConfig/**</Path>", "<Path>frontend/src/api/system/message/**</Path>", "<Path>frontend/src/api/system/social/**</Path>", "<Path>frontend/src/views/system/dict/**</Path>", "<Path>frontend/src/views/system/config/**</Path>", "<Path>frontend/src/views/system/notice/**</Path>", "<Path>frontend/src/views/system/oss/**</Path>", "<Path>frontend/src/views/system/ossConfig/**</Path>", "<Path>frontend/src/views/system/message/**</Path>", "<Path>frontend/src/views/system/social/**</Path>", "<Path>frontend/e2e/system-resources.spec.ts</Path>"]
read_only_paths: ["<Path>frontend/src/components/**</Path>", "<Path>frontend/packages/domains/identity-access/**</Path>", "<Path>frontend/package.json</Path>"]
shared_paths: []
shared_path_owners: []
---
