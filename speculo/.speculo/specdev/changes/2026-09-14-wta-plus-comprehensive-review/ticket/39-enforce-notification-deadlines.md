...
shared_path_owners: ["<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/service/runtime/</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/usecase/</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-modules/wta-notify/src/main/java/org/namewta/notify/dao/NotifyNotificationDao.java</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-admin/src/main/java/org/namewta/web/controller/CaptchaController.java</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-modules/wta-profile/wta-profile-person/src/main/java/org/namewta/profile/person/service/PersonRebindNotificationService.java</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-modules/wta-profile/wta-profile-enterprise/src/main/java/org/namewta/profile/enterprise/service/EnterpriseTransferService.java</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-admin/src/test/java/org/namewta/test/notify/</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-admin/src/test/java/org/namewta/test/profile/</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)", "<Path>backend/wta-modules/wta-notify/src/test/</Path> => single-agent (Lead; exclusive current workspace; T-39 turn only)"]
---
...
2. Captcha/PersonRebind 等时效调用一次计算截止时刻并共享 TTL；保留 EnterpriseTransfer 现有截止合同。
