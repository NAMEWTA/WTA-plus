...
expected_changes: ["<Path>frontend/packages/domains/workflow/**</Path>", "<Path>frontend/packages/web-domains/workflow/**</Path>", "<Path>frontend/packages/domains/system-admin/README.md</Path>", "<Path>frontend/packages/domains/system-admin/package.json</Path>", "<Path>frontend/packages/domains/system-admin/tsconfig.json</Path>", "<Path>frontend/packages/domains/system-admin/public/user/**</Path>", "<Path>frontend/src/api/workflow/**</Path>", "<Path>frontend/src/views/workflow/**</Path>", "<Path>frontend/src/components/Process/**</Path>", "<Path>frontend/src/components/UserSelect/**</Path>", "<Path>frontend/src/components/TreePanel/**</Path>", "<Path>frontend/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
writable_paths: ["<Path>frontend/packages/domains/workflow/**</Path>", "<Path>frontend/packages/web-domains/workflow/**</Path>", "<Path>frontend/packages/domains/system-admin/README.md</Path>", "<Path>frontend/packages/domains/system-admin/package.json</Path>", "<Path>frontend/packages/domains/system-admin/tsconfig.json</Path>", "<Path>frontend/packages/domains/system-admin/public/user/**</Path>", "<Path>frontend/src/api/workflow/**</Path>", "<Path>frontend/src/views/workflow/**</Path>", "<Path>frontend/src/components/Process/**</Path>", "<Path>frontend/src/components/UserSelect/**</Path>", "<Path>frontend/src/components/TreePanel/**</Path>", "<Path>frontend/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/e2e/workflow-runtime.spec.ts</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
read_only_paths: ["<Path>frontend/packages/domains/identity-access/**</Path>", "<Path>frontend/src/api/system/user/**</Path>", "<Path>frontend/src/api/system/dept/**</Path>", "<Path>frontend/package.json</Path>"]
shared_paths: ["<Path>frontend/packages/domains/system-admin/README.md</Path>", "<Path>frontend/packages/domains/system-admin/package.json</Path>", "<Path>frontend/packages/domains/system-admin/tsconfig.json</Path>", "<Path>frontend/packages/domains/system-admin/public/user/**</Path>", "<Path>frontend/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
shared_path_owners: ["<Path>frontend/packages/domains/system-admin/README.md</Path> => T-10 package owner; T-09 scoped activation writer for the minimum public user seam only (DEV-T09-001)", "<Path>frontend/packages/domains/system-admin/package.json</Path> => T-10 package owner; T-09 scoped activation writer for the minimum public user seam only (DEV-T09-001)", "<Path>frontend/packages/domains/system-admin/tsconfig.json</Path> => T-10 package owner; T-09 scoped activation writer for the minimum public user seam only (DEV-T09-001)", "<Path>frontend/packages/domains/system-admin/public/user/**</Path> => T-09 public seam owner; T-10 consumer/implementation owner must preserve exports", "<Path>frontend/src/router/adminManifestRegistry.ts</Path> => T-08 composition owner and T-15 convergence owner; T-09 may only inject FileUpload/close-current-page host ports and expose the composed workflow runtime for compatibility facades (DEV-T09-002)", "<Path>frontend/pnpm-lock.yaml</Path> => T-03 policy owner; T-09 scoped writer for the system-admin importer and workflow dependency specifier only (DEV-T09-001)"]
---
