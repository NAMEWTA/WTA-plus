...
expected_changes: ["<Path>frontend/packages/domains/identity-access/**</Path>", "<Path>frontend/packages/web-domains/identity-access/**</Path>", "<Path>frontend/packages/platform/auth/**</Path>", "<Path>frontend/packages/platform/permission/**</Path>", "<Path>frontend/packages/platform/app-runtime/**</Path>", "<Path>frontend/src/permission.ts</Path>", "<Path>frontend/src/router/**</Path>", "<Path>frontend/src/store/modules/user.ts</Path>", "<Path>frontend/src/store/modules/permission.ts</Path>", "<Path>frontend/src/directive/permission/**</Path>", "<Path>frontend/src/api/login.ts</Path>", "<Path>frontend/src/api/menu.ts</Path>", "<Path>frontend/src/views/login.vue</Path>", "<Path>frontend/src/views/register.vue</Path>", "<Path>frontend/e2e/client-auth-context.spec.ts</Path>", "<Path>frontend/src/utils/request.test.ts</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
writable_paths: ["<Path>frontend/packages/domains/identity-access/**</Path>", "<Path>frontend/packages/web-domains/identity-access/**</Path>", "<Path>frontend/packages/platform/auth/**</Path>", "<Path>frontend/packages/platform/permission/**</Path>", "<Path>frontend/packages/platform/app-runtime/**</Path>", "<Path>frontend/src/permission.ts</Path>", "<Path>frontend/src/router/**</Path>", "<Path>frontend/src/store/modules/user.ts</Path>", "<Path>frontend/src/store/modules/permission.ts</Path>", "<Path>frontend/src/directive/permission/**</Path>", "<Path>frontend/src/plugins/auth.ts</Path>", "<Path>frontend/src/utils/permission.ts</Path>", "<Path>frontend/src/api/login.ts</Path>", "<Path>frontend/src/api/menu.ts</Path>", "<Path>frontend/src/api/types.ts</Path>", "<Path>frontend/src/views/login.vue</Path>", "<Path>frontend/src/views/register.vue</Path>", "<Path>frontend/src/views/socialCallback.vue</Path>", "<Path>frontend/e2e/client-auth-context.spec.ts</Path>", "<Path>frontend/src/utils/request.test.ts</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
read_only_paths: ["<Path>frontend/packages/adapters/**</Path>", "<Path>frontend/apps/client-web/**</Path>", "<Path>frontend/package.json</Path>"]
shared_paths: ["<Path>frontend/src/permission.ts</Path>", "<Path>frontend/src/router/**</Path>", "<Path>frontend/src/store/modules/user.ts</Path>", "<Path>frontend/src/store/modules/permission.ts</Path>", "<Path>frontend/package.json</Path>", "<Path>frontend/pnpm-lock.yaml</Path>"]
shared_path_owners: ["<Path>frontend/src/permission.ts</Path> => T-07", "<Path>frontend/src/router/**</Path> => T-07", "<Path>frontend/src/store/modules/user.ts</Path> => T-07", "<Path>frontend/src/store/modules/permission.ts</Path> => T-07", "<Path>frontend/package.json</Path> => T-03 policy owner; T-07 scoped writer for root facades' actual internal workspace:* consumers only (DEV-T07-001)", "<Path>frontend/pnpm-lock.yaml</Path> => T-03 policy owner; T-07 scoped writer for matching root specifiers and T-07 manifest importers only (DEV-T07-001)"]
---
...
- `DEV-T07-002`：T-01 的直接 `/auth/login` characterization 是迁移前基线，已被本 Ticket 的 `AC-015` 严格 Client 前置合同取代。T-07 可更新 `<Path>frontend/src/utils/request.test.ts</Path>` 中该测试及所需 session mock，使其验证 `context -> code -> login`；生产 `<Path>frontend/src/utils/request.ts</Path>` 继续只读，401/request adapter 断言不得放宽。
