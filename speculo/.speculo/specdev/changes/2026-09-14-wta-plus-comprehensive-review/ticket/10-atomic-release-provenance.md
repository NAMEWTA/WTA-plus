...
skill_bindings: [{"id": "engineering-standards", "path": "<Path>.agents/skills/engineering-standards/SKILL.md</Path>", "sha256": "dbc475149e3588cb840c15e0bb287920b876c0eef4c4004dde078de1c4fca6d9", "phase": "implement", "operation": "apply-scope-contract", "inputs": ["<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/tickets-map.md</Path>", "<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/ticket/10-atomic-release-provenance.md</Path>", "<Path>release-artifacts/scripts/release-manage.sh</Path>", "<Path>release-artifacts/scripts/verify-release.sh</Path>"], "outputs": ["T-10的边界/调用方/持久化与实现检查记录"], "required": true, "on_failure": "block-ticket"}, {"id": "engineering-standards", "path": "<Path>.agents/skills/engineering-standards/SKILL.md</Path>", "sha256": "dbc475149e3588cb840c15e0bb287920b876c0eef4c4004dde078de1c4fca6d9", "phase": "verify", "operation": "verify-affected-contract-and-quality-gates", "inputs": ["<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/ticket/10-atomic-release-provenance.md</Path>", "当前diff与验证矩阵"], "outputs": ["<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/evidence/T-10-replan-2026-09-23.md</Path>"], "required": true, "on_failure": "block-ticket"}]
resource_claims: ["workspace:current-exclusive", "contract:AC-010"]
artifact: "ticket"
...
shared_path_owners: ["<Path>release-artifacts/scripts/release-manage.sh</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/scripts/verify-release.sh</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/tests/</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/README.md</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/docker/docker-compose-backend.yml</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/docker/docker-compose-frontend.yml</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/scripts/docker-manage.sh</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/scripts/release-state.mjs</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/skills/wta-namewta-nginx-config/SKILL.md</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>release-artifacts/skills/wta-namewta-nginx-config/scripts/add_app.mjs</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>.agents/skills/deploy-namewta-environment/references/build-transfer-release.md</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>.agents/skills/engineering-standards/references/project/00-project-profile.md</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)", "<Path>scripts/ci/verify-admin-bundle.sh</Path> => single-agent (Lead; exclusive current workspace; T-10 turn only)"]
---
...
- 来源：D-03, D-10；AC-010；本轮用户请求与<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/source.md</Path>。
- 当前事实：不可变完整release candidate及manifest同源保持；本地隔离候选与真实部署必须分开。
...
既有合同保持；本轮重新评审与验收；不可变完整release candidate及manifest同源保持；本地隔离候选与真实部署必须分开。 完整决定及来源以<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/ADR.md</Path>为准。
...
manifest每个artifact的digest和source可追溯 正常、失败、越权和竞争路径按本票验收断言共同交付，不把前后端或测试分成无价值空票。

## 5. 实现契约

- 入口与输入输出：required: 隔离文件系统完整stage、缺件/中断/混源注入、固定版本消费者与容器重建恢复。
- 外部行为：manifest每个artifact的digest和source可追溯
...
|---|---|---|---|
| 正常 | required: 隔离文件系统完整stage、缺件/中断/混源注入、固定版本消费者与容器重建恢复 | manifest每个artifact的digest和source可追溯 | <Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/evidence/T-10-replan-2026-09-23.md</Path> |
| 失败/竞争 | 缺模板/坏SQL/坏JAR/中断时current/context SHA256完全不变 | 明确失败/安全恢复，无伪成功、越权及部分提交 | 同上，记录故障注入与状态 |
| 回归 | 现有同域测试＋消费者＋适用静态门禁 | 单目标构建不能stage为完整release；恢复只操作本次stage，不触及他人文件或历史发布 | 同上，记录测试数/skip/源码 |
...
历史implementation commit：`e730305a50d9065fdc8af454770b3267983ae982`；历史result：`6c8764cca97bb6057fcb90ccdfe635c7efbf502a`。提交存在及祖先关系见<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/reviews/legacy-ticket-audit.json</Path>。

<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/evidence/T-10.md</Path>及其引用日志是历史证据，本轮未重跑业务测试。原Ticket全文见<Path>{roots.state}/specdev/changes/2026-09-14-wta-plus-comprehensive-review/reviews/replan-2026-09-23-before/ticket/10-atomic-release-provenance.md</Path>，不得按旧“尚未实现/提交暂缓”描述重复执行。
