...
start = time.time()
try:
    mysql = run(['docker', 'run', '-d', '--name', 'namewta-t30-profile-mysql-' + suffix, '--label', 'namewta.test.owner=T-30', '-p', '127.0.0.1::3306',
    ...
    redis = run(['docker', 'run', '-d', '--name', 'namewta-t30-profile-redis-' + suffix, '--label', 'namewta.test.owner=T-30', '-p', '127.0.0.1::6379', images['redis'], 'redis-server', '--save', '', '--appendonly', 'no'])
    ...
    minio = run(['docker', 'run', '-d', '--name', 'namewta-t30-profile-minio-' + suffix, '--label', 'namewta.test.owner=T-30', '-p', '127.0.0.1::9000',
