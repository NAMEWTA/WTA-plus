...
|---|---|---|---|---|---|---|---|---|---|---|
| T-00 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/00-authorization-gate.md</Path>` | 三门 Gate 投影；Review≠Implement | — | standard | high | yes | unassigned | AC-012, NAC-04 | G-Auth | ready |
| T-01 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/01-source-baseline.md</Path>` | SOURCE-BASELINE 文档可对照 | T-00 | standard | medium | yes | unassigned | AC-009, AC-012 | W-Inv | ready |
| T-02 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/02-ownership-inventory.md</Path>` | evidence/inventory 分类表 | T-01 | standard | high | no | unassigned | AC-001, AC-002, AC-007, NAC-01 | W-Inv | blocked |
| T-03 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/03-keep-inventory.md</Path>` | KEEP 清单可回归 | T-01 | standard | high | no | unassigned | AC-003, NAC-01, NAC-05 | W-Inv | blocked |
| T-04 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/04-monorepo-layout.md</Path>` | docs→WTA-plus 对照+准备树 | T-02,T-03 | deep | critical | no | unassigned | AC-011, AC-008, NAC-06 | W0b | blocked |
| T-16 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/16-freeze-old-remotes.md</Path>` | freeze 语义 checklist（alias T04b） | T-00 | deep | critical | no | unassigned | AC-010, AC-011, NAC-03 | W0b | blocked |
| T-05 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/05-backend-org-wta.md</Path>` | 自有 org.namewta；KEEP 绿 | T-04,T-16 | standard | critical | no | unassigned | AC-002, AC-003, NAC-01, NAC-06 | W-rename | blocked |
| T-06 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/06-fe-docs-rename.md</Path>` | FE/docs OWNED + 去上游 URL | T-04 | standard | high | no | unassigned | AC-001, NAC-01 | W-rename | blocked |
| T-07 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/07-prefix-wta-x.md</Path>` | ruoyi-X→wta-X | T-05 | standard | high | no | unassigned | AC-004, NAC-01 | W-rename | blocked |
| T-08 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/08-nacos-hard-cut.md</Path>` | 硬切对照+发版窗口 checklist | T-05,T-06,T-07 | deep | critical | no | unassigned | AC-005, AC-006 | W-runtime | blocked |
| T-17 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/17-db-user-migrate.md</Path>` | 旧库用户 ruoyi→wta + 回滚 | T-08 | deep | high | no | unassigned | AC-001, AC-005 | W-runtime | blocked |
| T-09 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/09-residual.md</Path>` | residual 分类报告 | T-08 | standard | medium | no | unassigned | AC-007, NAC-05 | W-verify | blocked |
| T-10 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/10-build-keep-verify.md</Path>` | build+KEEP 日志 | T-09 | standard | high | no | unassigned | AC-001, AC-002, AC-003, AC-004 | W-verify | blocked |
| T-11 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/11-e2e-optional.md</Path>` | E2E 或 waiver | T-10 | standard | medium | no | unassigned | AC-005 | W-verify | blocked |
| T-12 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/12-publication-readiness.md</Path>` | publication checklist（含清 .gitee） | T-10,T-11 | standard | critical | no | unassigned | AC-009 | W-PubReady | blocked |
| T-13 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/13-pub-auth.md</Path>` | CTO publication auth 记录 | T-12 | standard | critical | no | unassigned | AC-009, AC-012 | G-Auth-Pub | blocked |
| T-14 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/14-orphan-wta-plus.md</Path>` | orphan push NAMEWTA/WTA-plus | T-13 | deep | critical | no | unassigned | AC-008, AC-009, AC-011 | W-Pub | blocked |
| T-15 | `<Path>{roots.state}/specdev/changes/2026-09-12-rename-ruoyi-dromara-to-wta/ticket/15-legacy-freeze.md</Path>` | 旧仓 freeze transition | T-14 | deep | high | no | unassigned | AC-010 | W-Legacy | blocked |
