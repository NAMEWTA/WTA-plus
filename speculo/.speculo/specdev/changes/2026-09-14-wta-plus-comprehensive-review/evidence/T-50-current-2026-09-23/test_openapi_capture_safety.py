#!/usr/bin/env python3
"""Offline checks for T-50 owned full-JAR OpenAPI capture; no service launch."""
...
SCRIPT = Path('/tmp/wta-t50/capture-live-openapi.py')
spec = importlib.util.spec_from_file_location('t50_openapi_capture', SCRIPT)
