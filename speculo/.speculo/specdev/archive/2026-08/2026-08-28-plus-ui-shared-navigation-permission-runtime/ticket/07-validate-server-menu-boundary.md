...
expected_changes: ["<Path>frontend/packages/domains/admin/src/**</Path>", "<Path>frontend/packages/platform/app-runtime/src/routeAssembler.ts</Path>", "<Path>frontend/packages/platform/app-runtime/src/routeAssembler.test.ts</Path>", "<Path>frontend/apps/admin-web/src/store/modules/navigation.ts</Path>", "<Path>frontend/apps/admin-web/src/store/modules/navigation.test.ts</Path>", "<Path>frontend/apps/admin-web/src/router/serverMenuAdapter.ts</Path>", "<Path>frontend/apps/admin-web/src/router/serverMenuAdapter.test.ts</Path>"]
writable_paths: ["<Path>frontend/packages/domains/admin/src/**</Path>", "<Path>frontend/packages/platform/app-runtime/src/routeAssembler.ts</Path>", "<Path>frontend/packages/platform/app-runtime/src/routeAssembler.test.ts</Path>", "<Path>frontend/apps/admin-web/src/store/modules/navigation.ts</Path>", "<Path>frontend/apps/admin-web/src/store/modules/navigation.test.ts</Path>", "<Path>frontend/apps/admin-web/src/router/serverMenuAdapter.ts</Path>", "<Path>frontend/apps/admin-web/src/router/serverMenuAdapter.test.ts</Path>"]
read_only_paths: ["<Path>frontend/packages/api-contracts/src/generated/**</Path>", "<Path>ruoyi-vue-plus-namewta/**</Path>", "<Path>frontend/apps/admin-web/src/router/adminManifestRegistry.ts</Path>", "<Path>frontend/apps/admin-web/src/router/manifestDiagnostic.ts</Path>"]
shared_paths: ["<Path>frontend/packages/platform/app-runtime/src/routeAssembler.ts</Path>"]
shared_path_owners: ["<Path>frontend/packages/platform/app-runtime/src/routeAssembler.ts</Path> => T-07"]
---
