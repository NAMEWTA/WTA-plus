package org.namewta.common.redis.config;
...
import org.namewta.common.redis.handler.RedisExceptionHandler;
    ...
    public RedissonAutoConfigurationCustomizer redissonCustomizer() {
        return config -> {
            ...
            JsonMapper jsonMapper = JsonMapper.builder()
                ...
                // 一般而言，更加建议使用包名白名单的方式去进行匹配，以确保放行通过安全认可的类，如：BasicPolymorphicTypeValidator.builder().allowIfBaseType("org.namewta").allowIfSubType("org.namewta").build()
