#!/usr/bin/env python3
"""Run T-25 repository checks serially and retain real outcomes."""
import json
import os
...
shim = Path(tempfile.mkdtemp(prefix='t25-pnpm-', dir=root/'temp/team/lead'))
...
if mode == 'backend':
    commands = [('backend', ['./mvnw', '-B', '-ntp', '-pl', 'wta-modules/wta-system,wta-admin', '-am', 'test'])]
elif mode == 'module':
