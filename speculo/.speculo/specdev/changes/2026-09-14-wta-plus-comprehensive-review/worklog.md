...
revision226：T42事前补充SysOss实体/VO状态说明写集，共58根；NOT_READY不可作为普通可用附件，元数据与URL均仅接受ACTIVE。17done/2cancelled/1in_progress/30ready，完整候选attempts0，Goal active。 cors_audit唯一产品writer，Lead不并发构建；private runner准备完成，真实验收尚未运行。
