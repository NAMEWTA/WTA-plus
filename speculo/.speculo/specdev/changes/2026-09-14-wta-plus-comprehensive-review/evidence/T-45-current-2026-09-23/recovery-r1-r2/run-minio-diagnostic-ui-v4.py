...
RUN_ROOT = Path('/tmp/wta-t45/ui-v4-runs')
...
def exact_owned_bad_delete_sql(hexsql, id_bad, key_bad):
...
def main():
    ...
    try:
        ...
        sql = exact_owned_bad_delete_sql(h, id_bad, key_bad)
