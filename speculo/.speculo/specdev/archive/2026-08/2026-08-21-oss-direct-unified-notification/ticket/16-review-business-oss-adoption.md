...
owner: codex
expected_changes: ["<Path>ruoyi-vue-plus-namewta/ruoyi-modules/ruoyi-system/**</Path>", "<Path>frontend/src/views/system/notice/**</Path>"]
writable_paths: ["<Path>ruoyi-vue-plus-namewta/ruoyi-modules/ruoyi-system/**</Path>", "<Path>frontend/src/**</Path>"]
read_only_paths: []
shared_paths: []
shared_path_owners: []
---
