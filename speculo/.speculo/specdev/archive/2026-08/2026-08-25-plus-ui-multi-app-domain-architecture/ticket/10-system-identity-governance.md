...
owner: codex:/root
expected_changes: ["<Path>frontend/packages/domains/system-admin/**</Path>", "<Path>frontend/packages/web-domains/system-admin/**</Path>", "<Path>frontend/src/api/system/**</Path>", "<Path>frontend/src/views/system/**</Path>"]
writable_paths: ["<Path>frontend/packages/domains/system-admin/**</Path>", "<Path>frontend/packages/web-domains/system-admin/**</Path>", "<Path>frontend/src/api/system/client/**</Path>", "<Path>frontend/src/api/system/user/**</Path>", "<Path>frontend/src/api/system/userType/**</Path>", "<Path>frontend/src/api/system/role/**</Path>", "<Path>frontend/src/api/system/menu/**</Path>", "<Path>frontend/src/api/system/dept/**</Path>", "<Path>frontend/src/api/system/post/**</Path>", "<Path>frontend/src/views/system/client/**</Path>", "<Path>frontend/src/views/system/user/**</Path>", "<Path>frontend/src/views/system/userType/**</Path>", "<Path>frontend/src/views/system/role/**</Path>", "<Path>frontend/src/views/system/menu/**</Path>", "<Path>frontend/src/views/system/dept/**</Path>", "<Path>frontend/src/views/system/post/**</Path>", "<Path>frontend/e2e/system-identity.spec.ts</Path>"]
read_only_paths: ["<Path>frontend/packages/domains/system-admin/public/user/**</Path>", "<Path>frontend/packages/domains/identity-access/**</Path>", "<Path>frontend/src/permission.ts</Path>"]
shared_paths: []
shared_path_owners: []
---
