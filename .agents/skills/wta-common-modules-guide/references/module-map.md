...
- 源码根：`wta-common/wta-common-social/src/main/java/org/dromara/common/social/`
...
- 源码根：`wta-common/wta-common-core/src/main/java/org/dromara/common/core/`
...
- 源码根：`wta-common/wta-common-doc/src/main/java/org/dromara/common/doc/`
...
- 源码根：`wta-common/wta-common-excel/src/main/java/org/dromara/common/excel/`
...
- 源码根：`wta-common/wta-common-job/src/main/java/org/dromara/common/job/`
...
- 源码根：`wta-common/wta-common-log/src/main/java/org/dromara/common/log/`
...
- 源码根：`wta-common/wta-common-notify/src/main/java/org/dromara/common/notify/`
...
- 源码根：`wta-common/wta-common-mail/src/main/java/org/dromara/common/mail/`
...
- 源码根：`wta-common/wta-common-mybatis/src/main/java/org/dromara/common/mybatis/`
...
- 源码根：`wta-common/wta-common-oss/src/main/java/org/dromara/common/oss/`
...
- 源码根：`wta-common/wta-common-redis/src/main/java/org/dromara/common/redis/`
...
- 源码根：`wta-common/wta-common-satoken/src/main/java/org/dromara/common/satoken/`
...
- 源码根：`wta-common/wta-common-security/src/main/java/org/dromara/common/security/`
...
- 源码根：`wta-common/wta-common-sms/src/main/java/org/dromara/common/sms/`
...
- 源码根：`wta-common/wta-common-elasticsearch/src/main/java/org/dromara/common/elasticsearch/`
...
- 源码根：`wta-common/wta-common-web/src/main/java/org/dromara/common/web/`
...
- 源码根：`wta-common/wta-common-translation/src/main/java/org/dromara/common/translation/`
...
- 源码根：`wta-common/wta-common-sensitive/src/main/java/org/dromara/common/sensitive/`
...
- 源码根：`wta-common/wta-common-json/src/main/java/org/dromara/common/json/`
...
- 源码根：`wta-common/wta-common-encrypt/src/main/java/org/dromara/common/encrypt/`
...
- 源码根：`wta-common/wta-common-push/src/main/java/org/dromara/common/push/`
...
- 源码根：`wta-common/wta-common-liteflow/src/main/java/org/dromara/common/liteflow/`
...
- 源码根：`wta-common/wta-common-mqtt/src/main/java/org/dromara/common/mqtt/`
...
- 源码根：`wta-common/wta-common-ai/src/main/java/org/dromara/common/ai/`
...
- 源码根：`wta-common/wta-common-mcp/src/main/java/org/dromara/common/mcp/`
...
- 源码根：`wta-common/wta-common-openapi/src/main/java/org/dromara/common/openapi/`
...
| SPI | 接口路径 | system 实现 |
|---|---|---|
| `DictService` | `wta-common/wta-common-core/src/main/java/org/dromara/common/core/service/DictService.java`（「通用 字典服务」；`getDictLabel` / `getDictValue` / `getAllDictByDictType` / `getDictType` / `getDictData`） | `wta-modules/wta-system/src/main/java/org/dromara/system/service/impl/SysDictTypeServiceImpl.java`（`implements ISysDictTypeService, DictService`） |
| `PermissionService` | `wta-common/wta-common-core/src/main/java/org/dromara/common/core/service/PermissionService.java`（「用户权限处理」；`getRolePermission` / `getMenuPermission`） | `.../service/impl/SysPermissionServiceImpl.java`（`implements ISysPermissionService, PermissionService`） |
| `SensitiveService` | `wta-common/wta-common-sensitive/src/main/java/org/dromara/common/sensitive/core/SensitiveService.java`（「脱敏服务」；`isSensitive(roleKey[], perms[])`） | `.../service/impl/SysSensitiveServiceImpl.java` |
| `OpenApiAuthorizationResolver` | `wta-common/wta-common-openapi/src/main/java/org/dromara/common/openapi/spi/OpenApiAuthorizationResolver.java` | `.../openapi/authorization/SystemOpenApiAuthorizationResolver.java` |
| `OpenApiCredentialResolver` | `wta-common/wta-common-openapi/src/main/java/org/dromara/common/openapi/spi/OpenApiCredentialResolver.java` | `.../openapi/credential/service/SystemOpenApiCredentialResolver.java` |
| `OpenApiCallEventPublisher` | `wta-common/wta-common-openapi/src/main/java/org/dromara/common/openapi/spi/OpenApiCallEventPublisher.java` | 组装层可覆盖；common auto-configuration 提供 no-op 缺省实现 |
