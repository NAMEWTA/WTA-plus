...
expected_changes:
  ...
  - "<Path>frontend/packages/web-domains/system/src/index.ts</Path>"
  ...
  - "<Path>frontend/apps/admin-web/src/views/system/user/profile/index.vue</Path>"
writable_paths:
  - "<Path>frontend/packages/web-domains/system/src/open-api/**</Path>"
  - "<Path>frontend/packages/web-domains/system/src/index.ts</Path>"
  - "<Path>frontend/packages/web-domains/system/src/runtime.ts</Path>"
  - "<Path>frontend/packages/web-domains/system/src/index.test.ts</Path>"
  - "<Path>frontend/packages/web-domains/system/package.json</Path>"
  - "<Path>frontend/packages/web-domains/system/README.md</Path>"
  - "<Path>frontend/apps/admin-web/src/views/system/user/profile/index.vue</Path>"
  - "<Path>frontend/apps/admin-web/src/views/system/user/profile/openApi.vue</Path>"
  - "<Path>frontend/apps/admin-web/src/views/system/user/profile/openApi.test.ts</Path>"
  - "<Path>frontend/apps/admin-web/src/application/services.ts</Path>"
  - "<Path>frontend/apps/admin-web/src/router/adminManifestRegistry.ts</Path>"
...
read_only_paths:
  ...
  - "<Path>frontend/apps/admin-web/src/directives/permission/**</Path>"
shared_paths:
  - "<Path>frontend/packages/web-domains/system/src/index.ts</Path>"
  - "<Path>frontend/packages/web-domains/system/src/runtime.ts</Path>"
  - "<Path>frontend/packages/web-domains/system/src/index.test.ts</Path>"
  ...
  - "<Path>frontend/apps/admin-web/src/views/system/user/profile/index.vue</Path>"
shared_path_owners:
  - "<Path>frontend/packages/web-domains/system/src/index.ts</Path> => T-11"
  - "<Path>frontend/packages/web-domains/system/src/runtime.ts</Path> => T-11"
  - "<Path>frontend/packages/web-domains/system/src/index.test.ts</Path> => T-11"
  - "<Path>frontend/packages/web-domains/system/package.json</Path> => T-11"
  - "<Path>frontend/packages/web-domains/system/README.md</Path> => T-11"
  - "<Path>frontend/apps/admin-web/src/views/system/user/profile/index.vue</Path> => T-11"
---
